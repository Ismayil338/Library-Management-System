...
| **[Ali Hasanli](https://github.com/AliHasanli736)** | Contributed to LoginPageGUI, ProgramStart, UserFileManagerForLoginPageClass. | 28% |
| **[Ismayil Panahli](https://github.com/Ismayil338)** | Contributed to SignUpPageGUI, UserFileManagerForSignUp class and Readme File. | 28% |
| **[Kanan Abilov](https://github.com/Kananabilov)** | Prepared report of project in pdf and docx format and helped to fix some bugs in code. | 15% |
